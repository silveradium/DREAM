...
#please set your own relative path to preprocessed depth images here. In this example only subject 1 is considered.
image_path = 'data/processed_data/subj1/nsd_train_stim_sub1.npy'
train_images = batch_generator_external_images(data_path = image_path)

image_path = 'data/processed_data/subj1/nsd_test_stim_sub1.npy'
...
np.savez("data/extracted_features/subj1/nsd_vdvae_features_31l.npz",train_latents=train_latents,test_latents=test_latents)
